            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button class="btn btn-info" data-target="#exampleTabs" data-toggle="modal" type="button">ADD NEW SYSTEM USER</button>
                        <?php include $urls['add_user']; ?>
                        <?php 
                        include $urls['load_system_users'];
                        ?>
                    </div>
                </div>
            </div>
