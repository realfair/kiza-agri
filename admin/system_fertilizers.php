    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Available Fertilizers</h4>
                        <h6 class="card-subtitle">
                            you can Export data to Copy, CSV, Excel, PDF & Print
                        </h6>
                        <button class="btn btn-info" data-target="#exampleTabs" data-toggle="modal" type="button">ADD NEW FERTILIZER</button>
                        <?php include $urls['add_fertilizer']; ?>
                        <?php 
                        include $urls['load_system_fertilizers'];
                        ?>
                    </div>
                </div>
            </div>
