                ...
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <span class="uk-text-muted uk-text-small">Ibihingwa byose</span>
                            <h2 class="uk-margin-remove"><span class="countUpMe"><?php echo $cooperative->getCooperativeCropsNumber($cooperativeId); ?><noscript>12</noscript></span></h2>
                        </div>
                    </div>
                </div>
