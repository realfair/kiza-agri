    ...
    <div id="page_content">
        <div id="page_content_inner">
            ...
            <h3 class="heading_b uk-margin-bottom">
                Ibiciro bya Koperative :<?php echo $cooperativeName; ?>
            </h3>
            <!-- statistics (small charts) -->
            <?php include 'coo_pricing/add_modal.php'; ?>
            <?php include 'coo_pricing/price_statistics.php'; ?>
            <?php 
            $cropsCounter=$cooperative->getCooperativePriceNumber($cooperativeId);
            if($cropsCounter>0){
                ?>
                <?php include 'coo_pricing/load_pricing.php'; ?>
                <?php
            }else{
                ?>
