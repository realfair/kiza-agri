        ...
        <div class="md-card">
            <div class="md-card-content">
                <div class="uk-float-right uk-margin-top uk-margin-small-right">
                    <i style="font-size: 44px;" class="fa fa-bar-chart" aria-hidden="true"></i>
                </div>
                <span class="uk-text-muted uk-text-small">Umusaruro wose</span>
                <h2 class="uk-margin-remove"><span class="countUpMe"><?php echo $cooperative->getCooperativeTotalHarvest($cooperativeId); ?><noscript>12</noscript></span></h2>
            </div>
        </div>
    </div>
