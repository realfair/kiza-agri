                ...
                if($quantity==0){
                    ?>
                        <tr>
                            ...
                            <td>
                                <a coop="<?php echo $cooperativeId; ?>" data="<?php echo $fertilizerId; ?>" fertilizer="<?php echo $fertilizerName; ?>" class="md-btn md-btn-primary md-btn-mini giveMember" data-uk-tooltip title="Mukuremo" action="<?php echo $value['memberId']; ?>">
