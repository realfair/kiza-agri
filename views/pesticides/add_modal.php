...
$systemFertilizers=$cooperative->loadSystemPesticides();
?>
<div class="uk-modal" id="modal_header_footer">
    <div class="uk-modal-dialog">
        <div class="uk-modal-header">
            <h3 class="uk-modal-title"><?php echo $errors->add_pesticide_modal(); ?></h3>
        </div>
        <form id="frm_add_pesticide">
            <div class="row">
                <div class="uk-form-row">
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-1">
                            <label><?php echo $errors->pesticide_select_text(); ?></label>
                            <select id="fertilizer" class="md-input">
                                <?php 
                                foreach ($systemFertilizers as $key => $value) {
                                    ?>
                                    <option value="<?php echo $value['pesticideId']; ?>">
                                        <?php echo $value['name']; ?>
                                    </option>
                                    <?php
                                }
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-1">
                            <label><?php echo $errors->pesticide_quantity_text(); ?></label>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-1">
                            ...
                            <button id="btn_save_land" type="submit" class="md-btn md-btn-primary md-btn-large md-btn-wave-light md-btn-icon waves-effect waves-button waves-light">
                                    ...
                                    <?php echo $errors->save_pesticide_btn(); ?>
                                </a>
                        </div>
                    </div>
                </div>
